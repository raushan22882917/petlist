...
<div class="rtcl rtcl-listings-wrapper rtcl-divi-module">
	<?php
	$class = ! empty( $style ) ? 'rtcl-list-' . $style : 'rtcl-list-style-1';
	?>
    <div class="rtcl-listings rtcl-list-view <?php echo esc_attr( $class ); ?> ">
		...
		while ( $the_loops->have_posts() ) :
            ...
            <div <?php Functions::listing_class( [ 'rtcl-widget-listing-item', 'listing-item', $img_position_class ] ); ?>>
                        ...
                        <div class="rtcl-text-el-button">
                            <a class="rtcl-quick-view" href="#" title="<?php esc_attr_e( 'Quick View', 'classified-listing-toolkits' ); ?>"
                               data-listing_id="<?php echo absint( $_id ); ?>">
                                ...
                                <span><?php esc_html_e( 'Quick View', 'classified-listing-toolkits' ); ?></span>
                            </a>
                        </div>
						<?php
						$button_icon ++;
					...
					if ( 'on' === $instance['rtcl_show_compare'] ) :
                        ...
                        <div class="rtcl-text-el-button">
                            ...
                            <a class="rtcl-compare <?php echo esc_attr( $selected_class ); ?>" href="#"
                               title="<?php esc_attr_e( 'Compare', 'classified-listing-toolkits' ); ?>" data-listing_id="<?php echo absint( $_id ); ?>">
                                <i class="rtcl-icon rtcl-icon-retweet"></i>
                                <span><?php esc_html_e( 'Compare', 'classified-listing-toolkits' ); ?></span>
                            </a>
                        </div>
						<?php
						$button_icon ++;
				...
				if ( $button_icon ) {
					$button = sprintf( '<div class="rtcl-meta-buttons-withtext meta-button-count-%s">%s %s %s</div>', $button_icon, $dispaly_favourites,
						$dispaly_quick_view, $dispaly_compare );
				}
				...
				if ( 'on' === $instance['rtcl_show_details_button'] ) {
					$item_details_page_link = sprintf(
						...
						get_the_permalink(),
						esc_html__( 'Details', 'classified-listing-toolkits' )
					);
				}
