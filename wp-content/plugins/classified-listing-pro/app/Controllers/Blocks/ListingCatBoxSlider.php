...
/**
 * Main Blocks ListingCatBoxSlider Class
 *
...
class ListingCatBoxSlider
{
	protected $name = 'rtcl/listing-cat-box-slider';
		...
		$attributes = array(
			...
			"contentHoverColor" => array(
				...
				'style' => [
					...
					{color:{{contentHoverColor}} !important;}']
				],
			),
	...
	public function render_callback_listing_cat_box($attributes)
	{
		...
		$data = array(
			'template' => 'block/category-slider/style-' . $style,
			'style' => $style,
			'settings' => $settings,
