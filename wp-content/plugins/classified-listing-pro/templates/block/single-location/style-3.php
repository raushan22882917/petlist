...
<div class="<?php echo esc_attr($wrap_class); ?>">
	<div class="rtcl">
		<div class="rtcl-gb-listing-location-box location-box-pro <?php echo esc_attr($class); ?>">
			...
			<div class="rtcl-gb-content">
				...
				<?php endif; ?>
				<h3 class="rtcl-gb-title">
					<a href="<?php echo esc_url($term['permalink']); ?>">
				...
				<?php if ($settings['enable_link']) { ?>
					<a href="<?php echo esc_url($term['permalink']); ?>">
						<i class="rtcl-icon rtcl-icon-right-big"></i>
					</a>
				<?php } ?>
			</div>
		</div>
