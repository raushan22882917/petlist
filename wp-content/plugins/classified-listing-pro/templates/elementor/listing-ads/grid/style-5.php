						...
						<div class="rtin-bottom <?php echo ! empty( $instance['rtcl_show_user'] ) ? 'has-author' : ''; ?>">
							<ul>
								...
								<?php if ( Functions::is_enable_favourite() && $instance['rtcl_show_favourites'] ) : ?>
									<li class="action-btn">
										<?php
										echo Functions::get_favourites_link( $_id );
										?>
									</li>
								<?php endif; ?>
								<?php
								...
								if ( rtcl()->has_pro() ) {
									if ( ! empty( $instance['rtcl_show_compare'] ) ) :
										...
										<li class="action-btn">
											...
											?>
											<a class="rtcl-compare <?php echo esc_attr( $selected_class ); ?>" href="#" title="<?php esc_attr_e( 'Compare', 'classified-listing-pro' ); ?>" data-listing_id="<?php echo absint( $_id ); ?>"><i class="rtcl-icon rtcl-icon-retweet"></i>
											</a>
										</li>
										<?php
									endif;
