...
function petslist_image_paths()
{
	...
	return apply_filters(
		...
		array(
			...
			'about_baby_puppy' => 'theme:demo/about-baby-puppy.png',
			'pricing_shape' => 'theme:demo/pricing-card-shape.svg',
			'auth_banner' => 'theme:demo/auth-dog.png',
...
function petslist_render_dog_breeds($limit = 0)
{
	...
	<li class="category-item dda-post-ad-item"
		...
		<a href="<?php echo esc_url($add_dog_url); ?>"
			...
			<div class="icon"
				style="background: rgba(255, 255, 255, 0.2); width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 14px; flex-shrink: 0; box-shadow: none;">
		...
		<article class="dd-dir-card<?php echo esc_attr($sponsored_class); ?>">
			<div class="dd-dir-card__image">
				<a href="<?php echo esc_url(get_permalink($pid)); ?>" class="dd-dir-card__image-link">
					<img src="<?php echo esc_url($thumb); ?>" alt="<?php echo esc_attr(get_the_title($pid)); ?>"
						loading="lazy">
			...
			<div class="dd-dir-card__body">
				...
				<h3 class="dd-dir-card__name">
					<a
						href="<?php echo esc_url(get_permalink($pid)); ?>"><?php echo esc_html(get_the_title($pid)); ?></a>
				</h3>
