...
$pending_ads_count = (int) (wp_count_posts('dd_dog')->pending ?? 0);

// Admin nav
$admin_nav = [
    'overview'    => ['icon'=>'chart',   'label'=>__('Overview','petslist')],
    'approvals'   => ['icon'=>'check',   'label'=>__('Ad Approvals','petslist'), 'badge'=>$pending_ads_count],
    'dogs'        => ['icon'=>'dogs',    'label'=>__('All Studs','petslist')],
    'add-dog'     => ['icon'=>'plus',    'label'=>__('Add New Stud','petslist')],
...
function dda_icon($k) {
    $i = [
        ...
        'check'   => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" width="18" height="18"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>',
        ...
        'plus'    => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" width="18" height="18"><path d="M12 5v14M5 12h14"/></svg>',
        ...
        <nav class="ddu-sidebar__nav">
            ...
            <a href="<?php echo esc_url(dd_dashboard_url($key)); ?>"
               class="ddu-sidebar__nav-item <?php echo $active ? 'ddu-sidebar__nav-item--active' : ''; ?>">
                ...
                <span class="dda-nav-badge" style="margin-left: auto; background: #f59e0b; color: #fff; font-size: 11px; font-weight: 700; padding: 2px 8px; border-radius: 10px;"><?php echo $item['badge']; ?></span>
                <?php endif; ?>
            </a>
            <?php endforeach; ?>
        </nav>
    ...
    <main class="ddu-main" id="ddu-main">
        ...
        <header class="ddu-topbar">
            ...
            <div class="ddu-topbar__right">
                <a href="<?php echo esc_url(dd_dashboard_url('add-dog')); ?>" class="ddu-btn-primary" style="font-size: 12px; padding: 6px 14px; height: auto; line-height: 1.5; background-color: #02c5bd; color: #fff; font-weight: 700; border-radius: 6px; text-decoration: none; display: inline-flex; align-items: center; gap: 4px;">
                    + <?php _e('Add New Stud','petslist'); ?>
                </a>
        ...
        <div class="ddu-content">
            ...
            $admin_tabs = [
                ...
                'approvals'   => get_template_directory() . '/template-parts/dashboard/admin-tab-approvals.php',
                'dogs'        => get_template_directory() . '/template-parts/dashboard/admin-tab-dogs.php',
                'add-dog'     => get_template_directory() . '/template-parts/dashboard/tab-add-dog.php',
