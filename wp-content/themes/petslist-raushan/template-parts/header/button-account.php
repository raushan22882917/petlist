...
$login_link = is_user_logged_in() ? home_url('/dog-dashboard/') : home_url('/login/');

?>
<a class="header-login-icon" data-toggle="tooltip" title="<?php echo esc_html($login_icon_title); ?>"
    ...
    <?php if (is_user_logged_in()):
        ...
        <span class="header-login-avatar-wrap">
            <img src="<?php echo esc_url($avatar_url); ?>" alt="<?php echo esc_attr($login_icon_title); ?>"
                class="header-login-avatar" width="32" height="32"
                style="width:32px;height:32px;border-radius:50%;object-fit:cover;display:block;flex-shrink:0;">
        </span>
    <?php else: ?>
