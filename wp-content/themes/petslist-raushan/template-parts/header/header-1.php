...
?>
<div class="main-header header-style-1 rt-primary-color-bg <?php echo esc_attr( $sticky_header ); ?> header--fixed headroom">
    <div class="<?php echo esc_attr( $header_container ); ?>">
        <div class="main-header-inner">
            <?php get_template_part( 'template-parts/header/logo', '1' ) ?>
            <?php get_template_part( 'template-parts/header/site', 'nav' ) ?>
            <?php if ( Helper::is_chat_enabled() || Options::$options['header_login_icon'] || Options::$options['header_btn'] ): ?>
...
<div class="header-height-fixed header-style-1"></div>