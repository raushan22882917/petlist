...
?>
<div class="main-header header-style-5 rt-dark-color-bg <?php echo esc_attr( $sticky_header ); ?> header--fixed headroom">
...
<div class="header-height-fixed header-style-5"></div>