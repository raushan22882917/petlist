...
$style = Options::$options['listing_archive_search_filter_style'];

$can_search_by_keyword = Options::$options['listing_archive_search_filter_by_keyword'];
$can_search_by_type = Options::$options['listing_archive_search_filter_by_type'];
$can_search_by_category = Options::$options['listing_archive_search_filter_by_category'];
$can_search_by_location = Options::$options['listing_archive_search_filter_by_location'];
$can_search_by_radius_search = Options::$options['listing_archive_search_filter_by_radius_search'];
$can_search_by_price = Options::$options['listing_archive_search_filter_by_price'];
$can_search_by_custom_field = Options::$options['listing_archive_search_filter_by_custom_field'];
?>

<div class="rtcl rtcl-widget-search listing-inner listing-archive-search-filter">
    <form class="advance-search-form rtcl-widget-search-form is-preloader">
        ...
        <div class="search-box">
			<div class="fields-and-custom-fields-box">
				<div class="fields-and-custom-fields-box-left">
									...
									<?php if ($style === 'suggestion') { ?>
										...
										<div class="rtcl-search-input-button rtcl-search-input-category btn btn-primary">
											...
											<input type="hidden" name="rtcl_category" class="rtcl-term-field"
												value="<?php echo esc_attr( $selected_category ? esc_attr($selected_category->slug) : '' ); ?>">
										</div>
									<?php } ?>
								</div>
							<?php endif; ?>
						...
						<div class="col-md-12">
							...
							<div class="distance-search">
									...
									<div class="form-group ws-item ws-location">
										<div class="rtcl-geo-address-field-wrap">
				...
				<div class="fields-and-custom-fields-box-right">
					<?php
