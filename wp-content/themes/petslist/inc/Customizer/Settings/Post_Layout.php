	...
	public function register_single_post_layout_controls( $wp_customize ) {
		...
		$wp_customize->add_control( new Image_Radio( $wp_customize, 'single_post_layout',
			[
				...
				'description' => esc_html__( 'Select the default template layout for single post', 'petslist' ),
		...
		$wp_customize->add_control( 'single_post_padding_top',
			[
				'label'       => esc_html__( 'Content Padding Top (rem)', 'petslist' ),
				'description' => esc_html__( 'Single Post Content Padding Top ', 'petslist' ),
				'section'     => 'single_post_layout_section',
				'type'        => 'text',
			]
		);
		...
		$wp_customize->add_control( 'single_post_padding_bottom',
			[
				'label'       => esc_html__( 'Content Padding Bottom (rem)', 'petslist' ),
				'description' => esc_html__( 'Single Post Content Padding Bottom', 'petslist' ),
				'section'     => 'single_post_layout_section',
				'type'        => 'text',
			]
		);
