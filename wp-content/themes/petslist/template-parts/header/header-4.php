...
?>
<div class="main-header header-style-4 rt-white-color-bg <?php echo esc_attr( $sticky_header ); ?> header--fixed headroom">
...
<div class="header-height-fixed header-style-4"></div>